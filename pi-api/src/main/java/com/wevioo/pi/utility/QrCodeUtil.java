...
public class QrCodeUtil {
	...
	public static Image createQRImage(String qrCodeText) throws WriterException, IOException {
		...
		Image image = bufferedImage.getScaledInstance(matrixWidth, // Set your desired width
				matrixWidth, // Set your desired height
				Image.SCALE_SMOOTH);
